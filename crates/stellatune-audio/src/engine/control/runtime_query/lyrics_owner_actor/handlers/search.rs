...
pub(crate) struct LyricsSearchMessage {
    pub config_json: String,
    pub query_json: String,
}

impl Message for LyricsSearchMessage {
    type Response = Result<String, String>;
}

#[async_trait::async_trait]
impl Handler<LyricsSearchMessage> for LyricsOwnerActor {
    async fn handle(
        &mut self,
        message: LyricsSearchMessage,
        ...
        instance
            .search_json(&message.query_json)
