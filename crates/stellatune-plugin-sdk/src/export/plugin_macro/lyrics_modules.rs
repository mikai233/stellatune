    ...
    ($( $lyrics_mod:ident => $lyrics_ty:ty ),* $(,)?) => {
        $(
            mod $lyrics_mod {
                ...
                type LyricsJsonOpBox = $crate::async_task::AsyncTaskOp<String>;
                ...
                define_common_op_fns!(
                    lyrics_json_op_poll,
                    lyrics_json_op_wait,
                    lyrics_json_op_cancel,
                    lyrics_json_op_set_notifier,
                    lyrics_json_op_destroy,
                    LyricsJsonOpBox,
                    "lyrics_json_op"
                );
                ...
                extern "C" fn lyrics_json_op_take_json_utf8(
                    handle: *mut core::ffi::c_void,
                    out_json_utf8: *mut $crate::StStr,
                ) -> $crate::StStatus {
                    $crate::ffi_guard::guard_status("lyrics_json_op_take_json_utf8", || {
                        if handle.is_null() || out_json_utf8.is_null() {
                            return $crate::status_err_msg(
                                $crate::ST_ERR_INVALID_ARG,
                                "null handle/out_json_utf8",
                            );
                        }
                        let op = unsafe { &*(handle as *mut LyricsJsonOpBox) };
                        match op.take_result() {
                            Ok(json) => {
                                unsafe { *out_json_utf8 = $crate::alloc_utf8_bytes(&json); }
                                $crate::status_ok()
                            }
                            Err(err) => take_error_to_status("lyrics", err),
                        }
                    })
                }

                extern "C" fn unit_op_finish(handle: *mut core::ffi::c_void) -> $crate::StStatus {
                    $crate::ffi_guard::guard_status("lyrics_unit_op_finish", || {
                        if handle.is_null() {
                            return $crate::status_err_msg($crate::ST_ERR_INVALID_ARG, "null handle");
                        }
                ...
                extern "C" fn json_op_take_json_utf8(
                    ...
                    $crate::ffi_guard::guard_status("lyrics_json_state_take_json_utf8", || {
                        if handle.is_null() || out_json_utf8.is_null() {
                ...
                extern "C" fn plan_op_take_plan(
                    ...
                    $crate::ffi_guard::guard_status("lyrics_plan_op_take_plan", || {
                ...
                extern "C" fn begin_search_json_utf8(
                    handle: *mut core::ffi::c_void,
                    query_json_utf8: $crate::StStr,
                    out_op: *mut stellatune_plugin_api::StLyricsJsonOpRef,
                ) -> $crate::StStatus {
                    $crate::ffi_guard::guard_status("begin_search_json_utf8", || {
                        ...
                        let boxed = unsafe { &*(handle as *mut $crate::instance::LyricsProviderBox<LyricsImpl>) };
                        let provider = boxed.inner.clone();
                        let op = LyricsJsonOpBox::spawn(async move {
                            let mut guard = provider.lock().await;
                            <LyricsImpl as $crate::instance::LyricsProviderInstance>::search_json(&mut *guard, &query_json).await
                        });
                        unsafe {
                            *out_op = stellatune_plugin_api::StLyricsJsonOpRef {
                                handle: Box::into_raw(Box::new(op)) as *mut core::ffi::c_void,
                                vtable: &LYRICS_JSON_OP_VTABLE as *const _,
                                reserved0: 0,
                                reserved1: 0,
                            };
                        }
                ...
                extern "C" fn begin_fetch_json_utf8(
                    handle: *mut core::ffi::c_void,
                    track_json_utf8: $crate::StStr,
                    out_op: *mut stellatune_plugin_api::StLyricsJsonOpRef,
                ) -> $crate::StStatus {
                    $crate::ffi_guard::guard_status("begin_fetch_json_utf8", || {
                        if handle.is_null() || out_op.is_null() {
                            return $crate::status_err_msg($crate::ST_ERR_INVALID_ARG, "null handle/out_op");
                        }
                        ...
                        let op = LyricsJsonOpBox::spawn(async move {
                            let mut guard = provider.lock().await;
                            <LyricsImpl as $crate::instance::LyricsProviderInstance>::fetch_json(&mut *guard, &track_json).await
                        });
                        unsafe {
                            *out_op = stellatune_plugin_api::StLyricsJsonOpRef {
                                handle: Box::into_raw(Box::new(op)) as *mut core::ffi::c_void,
                ...
                extern "C" fn begin_plan_config_update_json_utf8(
                    ...
                    $crate::ffi_guard::guard_status("begin_plan_config_update_json_utf8", || {
                        ...
                        let op = PlanOpBox::spawn(async move {
                            ...
                            <LyricsImpl as $crate::update::ConfigUpdatable>::plan_config_update_json(&*guard, &new_json)
                        });
                        unsafe {
                ...
                extern "C" fn begin_apply_config_update_json_utf8(
                    ...
                    $crate::ffi_guard::guard_status("begin_apply_config_update_json_utf8", || {
                        ...
                        let op = UnitOpBox::spawn(async move {
                            let mut guard = provider.lock().await;
                            <LyricsImpl as $crate::update::ConfigUpdatable>::apply_config_update_json(&mut *guard, &new_json)
                        });
                        unsafe {
                ...
                extern "C" fn begin_export_state_json_utf8(
                    ...
                    $crate::ffi_guard::guard_status("begin_export_state_json_utf8", || {
                        ...
                        let op = JsonOpBox::spawn(async move {
                            let guard = provider.lock().await;
                            <LyricsImpl as $crate::update::ConfigUpdatable>::export_state_json(&*guard)
                        });
                        unsafe {
                ...
                extern "C" fn begin_import_state_json_utf8(
                    ...
                    $crate::ffi_guard::guard_status("begin_import_state_json_utf8", || {
                        ...
                        let op = UnitOpBox::spawn(async move {
                            let mut guard = provider.lock().await;
                            <LyricsImpl as $crate::update::ConfigUpdatable>::import_state_json(&mut *guard, &state_json)
                        });
                        unsafe {
                            *out_op = stellatune_plugin_api::StUnitOpRef {
                                handle: Box::into_raw(Box::new(op)) as *mut core::ffi::c_void,
                ...
                extern "C" fn destroy(handle: *mut core::ffi::c_void) {
                    $crate::ffi_guard::guard_void("lyrics_destroy", || {
                        if handle.is_null() {
                            return;
                        }
                ...
                pub static LYRICS_JSON_OP_VTABLE: stellatune_plugin_api::StLyricsJsonOpVTable =
                    stellatune_plugin_api::StLyricsJsonOpVTable {
                        poll: lyrics_json_op_poll,
                        wait: lyrics_json_op_wait,
                        cancel: lyrics_json_op_cancel,
                        set_notifier: lyrics_json_op_set_notifier,
                        take_json_utf8: lyrics_json_op_take_json_utf8,
                        destroy: lyrics_json_op_destroy,
                    };
                ...
                pub static VTABLE: stellatune_plugin_api::StLyricsProviderInstanceVTable =
                    stellatune_plugin_api::StLyricsProviderInstanceVTable {
                        begin_search_json_utf8,
                        begin_fetch_json_utf8,
                ...
                pub extern "C" fn create_instance(
                    ...
                    $crate::ffi_guard::guard_status("lyrics_create_instance", || {
                        ...
                        match <$lyrics_ty as $crate::instance::LyricsProviderDescriptor>::create(config) {
                            Ok(instance) => {
                                let boxed = Box::new($crate::instance::LyricsProviderBox {
