        ...
        $(
            mod $sink_mod {
                ...
                extern "C" fn list_targets_json_utf8(
                    ...
                    $crate::ffi_guard::guard_status("list_targets_json_utf8", || {
                ...
                extern "C" fn negotiate_spec(
                    ...
                    $crate::ffi_guard::guard_status("negotiate_spec", || {
                ...
                extern "C" fn write_interleaved_f32(
                    ...
                    $crate::ffi_guard::guard_status("write_interleaved_f32", || {
                ...
                extern "C" fn query_status(
                    ...
                    $crate::ffi_guard::guard_status("query_status", || {
                ...
                extern "C" fn flush(handle: *mut core::ffi::c_void) -> $crate::StStatus {
                    $crate::ffi_guard::guard_status("flush", || {
                        if handle.is_null() {
                            return $crate::status_err_msg($crate::ST_ERR_INVALID_ARG, "null handle");
                        }
                        let boxed = unsafe { &mut *(handle as *mut $crate::instance::OutputSinkBox<SinkImpl>) };
                ...
                extern "C" fn reset(handle: *mut core::ffi::c_void) -> $crate::StStatus {
                    $crate::ffi_guard::guard_status("reset", || {
                        if handle.is_null() {
                            return $crate::status_err_msg($crate::ST_ERR_INVALID_ARG, "null handle");
                        }
                        let boxed = unsafe { &mut *(handle as *mut $crate::instance::OutputSinkBox<SinkImpl>) };
                ...
                extern "C" fn close(handle: *mut core::ffi::c_void) {
                    $crate::ffi_guard::guard_void("close", || {
                        if handle.is_null() {
                            return;
                        }
                        let boxed = unsafe { &mut *(handle as *mut $crate::instance::OutputSinkBox<SinkImpl>) };
