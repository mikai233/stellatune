...
are used unless explicitly configured. Current output layouts are mono/stereo.
...
Pause retains accepted audio; seek resets both the mapping reader and driver
