...
class TrackList extends StatefulWidget {
  ...
  final Future<void> Function(TrackLite track, {Offset? anchorGlobalPosition})?
...
class _TrackListState extends State<TrackList> {
  ...
  List<TrackListActionSpec> _buildTrackActionSpecs(
    ...
    return <TrackListActionSpec>[
      ...
      TrackListActionSpec(
        ...
        enabled: widget.onTranscodeRequested != null,
      ),
      TrackListActionSpec(
  ...
  Future<void> _handleTrackAction({
    ...
    if (action == TrackListAction.transcode) {
      await widget.onTranscodeRequested?.call(
        track,
