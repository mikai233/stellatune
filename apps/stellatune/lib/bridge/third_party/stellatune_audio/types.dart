...
enum LfeMode {
  ...
  static Future<LfeMode> default_() =>
      StellatuneApi.instance.api.stellatuneAudioTypesLfeModeDefault();
}
...
enum ResampleQuality {
  ...
  static Future<ResampleQuality> default_() =>
      StellatuneApi.instance.api.stellatuneAudioTypesResampleQualityDefault();
}
...
class TrackRef {
  ...
  static Future<TrackRef> forLocalPath({required String path}) => StellatuneApi
      .instance
      .api
      .stellatuneAudioTypesTrackRefForLocalPath(path: path);
  ...
  }) => StellatuneApi.instance.api.stellatuneAudioTypesTrackRefNew(
    sourceId: sourceId,
    trackId: trackId,
    locator: locator,
  );
  ...
  Future<String> stableKey() => StellatuneApi.instance.api
      .stellatuneAudioTypesTrackRefStableKey(that: this);
