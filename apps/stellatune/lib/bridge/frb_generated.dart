...
class StellatuneApi
  ...
  @override
  int get rustContentHash => 2119364977;
...
abstract class StellatuneApiApi extends BaseApi {
  Future<void> stellatuneCoreRequestIdAsStr({required RequestId that});

  Future<String> stellatuneCoreRequestIdIntoInner({required RequestId that});

  Future<List<TrackPlayability>> crateApiPlayerCanPlayTrackRefs({
  ...
  Future<void> crateApiPlayerDisposePlayer({required Player player});
  ...
  Future<void> crateApiLibraryLibraryPluginsReloadFromState({
    required Library library_,
    required String dir,
  });
  ...
  Future<TrackRef> stellatuneCoreTrackRefNew({
  ...
  get rust_arc_decrement_strong_count_RequestId;

  CrossPlatformFinalizerArg get rust_arc_decrement_strong_count_RequestIdPtr;
}
...
class StellatuneApiApiImpl extends StellatuneApiApiImplPlatform
  ...
  Future<void> stellatuneCoreRequestIdAsStr({required RequestId that}) {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kStellatuneCoreRequestIdAsStrConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kStellatuneCoreRequestIdAsStrConstMeta =>
      const TaskConstMeta(debugName: "RequestId_as_str", argNames: ["that"]);
  ...
  Future<String> stellatuneCoreRequestIdIntoInner({required RequestId that}) {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kStellatuneCoreRequestIdIntoInnerConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kStellatuneCoreRequestIdIntoInnerConstMeta =>
      const TaskConstMeta(
        debugName: "RequestId_into_inner",
        argNames: ["that"],
      );
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_list_track_ref(tracks, serializer);
          pdeCallFfi(
            generalizedFrbRustBinding,
            serializer,
            funcId: 3,
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_list_track_playability,
          decodeErrorData: null,
        ),
        constMeta: kCrateApiPlayerCanPlayTrackRefsConstMeta,
        argValues: [player, tracks],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiPlayerCanPlayTrackRefsConstMeta =>
      const TaskConstMeta(
        debugName: "can_play_track_refs",
        argNames: ["player", "tracks"],
      );
  ...
  TaskConstMeta get kCrateApiPlayerDisposePlayerConstMeta =>
      const TaskConstMeta(debugName: "dispose_player", argNames: ["player"]);
  ...
  Future<LfeMode> stellatuneCoreLfeModeDefault() {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kStellatuneCoreLfeModeDefaultConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kStellatuneCoreLfeModeDefaultConstMeta =>
  ...
  Future<void> crateApiLibraryLibraryPluginsReloadFromState({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiLibraryLibraryPluginsReloadFromStateConstMeta,
        argValues: [library_, dir],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiLibraryLibraryPluginsReloadFromStateConstMeta =>
      const TaskConstMeta(
        debugName: "library_plugins_reload_from_state",
        argNames: ["library_", "dir"],
      );
  ...
  Future<TrackRef> stellatuneCoreTrackRefForLocalPath({required String path}) {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kStellatuneCoreTrackRefForLocalPathConstMeta,
        argValues: [path],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kStellatuneCoreTrackRefForLocalPathConstMeta =>
      const TaskConstMeta(
  ...
  Future<TrackRef> stellatuneCoreTrackRefNew({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kStellatuneCoreTrackRefNewConstMeta,
  ...
  TaskConstMeta get kStellatuneCoreTrackRefNewConstMeta => const TaskConstMeta(
  ...
  Future<String> stellatuneCoreTrackRefStableKey({required TrackRef that}) {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kStellatuneCoreTrackRefStableKeyConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kStellatuneCoreTrackRefStableKeyConstMeta =>
      const TaskConstMeta(
  ...
  RustArcDecrementStrongCountFnType
  get rust_arc_decrement_strong_count_RequestId => wire
  ...
  Event dco_decode_event(dynamic raw) {
    ...
    switch (raw[0]) {
      ...
      case 7:
        return Event_OutputDevicesChanged(
          devices: dco_decode_list_audio_device(raw[1]),
        );
      default:
  ...
  List<TrackPlayability> dco_decode_list_track_playability(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_track_playability).toList();
  }

  @protected
  List<TrackRef> dco_decode_list_track_ref(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_track_ref).toList();
  }
  ...
  TrackPlayability dco_decode_track_playability(dynamic raw) {
    ...
    return TrackPlayability(
      track: dco_decode_track_ref(arr[0]),
      playable: dco_decode_bool(arr[1]),
  ...
  sse_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerRequestId(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    return RequestIdImpl.frbInternalSseDecode(
  ...
  Event sse_decode_event(SseDeserializer deserializer) {
    ...
    switch (tag_) {
      ...
      case 7:
        var var_devices = sse_decode_list_audio_device(deserializer);
        return Event_OutputDevicesChanged(devices: var_devices);
      default:
        throw UnimplementedError('');
    }
  }
  ...
  List<TrackPlayability> sse_decode_list_track_playability(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <TrackPlayability>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_track_playability(deserializer));
    }
    return ans_;
  }
  ...
  List<TrackRef> sse_decode_list_track_ref(SseDeserializer deserializer) {
    ...
    var ans_ = <TrackRef>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_track_ref(deserializer));
    }
    return ans_;
  }
  ...
  TrackPlayability sse_decode_track_playability(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_track = sse_decode_track_ref(deserializer);
    var var_playable = sse_decode_bool(deserializer);
  ...
  sse_encode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerRequestId(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as RequestIdImpl).frbInternalSseEncode(move: true),
      serializer,
    );
  }
  ...
  sse_encode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerRequestId(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as RequestIdImpl).frbInternalSseEncode(move: false),
      serializer,
    );
  }
  ...
  sse_encode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerRequestId(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as RequestIdImpl).frbInternalSseEncode(move: null),
      serializer,
    );
  }
  ...
  void sse_encode_event(Event self, SseSerializer serializer) {
    ...
    switch (self) {
      ...
      case Event_Log(message: final message):
        ...
        sse_encode_String(message, serializer);
      case Event_OutputDevicesChanged(devices: final devices):
        sse_encode_i_32(7, serializer);
        sse_encode_list_audio_device(devices, serializer);
    }
  }
  ...
  void sse_encode_list_track_playability(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_track_playability(item, serializer);
    }
  }

  @protected
  void sse_encode_list_track_ref(
    List<TrackRef> self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_track_ref(item, serializer);
    }
  }
  ...
  void sse_encode_track_playability(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_track_ref(self.track, serializer);
    sse_encode_bool(self.playable, serializer);
...
@sealed
class RequestIdImpl extends RustOpaque implements RequestId {
  // Not to be used by end users
  RequestIdImpl.frbInternalDcoDecode(List<dynamic> wire)
    : super.frbInternalDcoDecode(wire, _kStaticData);

  // Not to be used by end users
  RequestIdImpl.frbInternalSseDecode(BigInt ptr, int externalSizeOnNative)
    : super.frbInternalSseDecode(ptr, externalSizeOnNative, _kStaticData);

  static final _kStaticData = RustArcStaticData(
    rustArcIncrementStrongCount:
        StellatuneApi.instance.api.rust_arc_increment_strong_count_RequestId,
    rustArcDecrementStrongCount:
        StellatuneApi.instance.api.rust_arc_decrement_strong_count_RequestId,
    rustArcDecrementStrongCountPtr:
        StellatuneApi.instance.api.rust_arc_decrement_strong_count_RequestIdPtr,
  );

  Future<void> asStr() =>
      StellatuneApi.instance.api.stellatuneCoreRequestIdAsStr(that: this);

  Future<String> intoInner() =>
      StellatuneApi.instance.api.stellatuneCoreRequestIdIntoInner(that: this);
}
